...
async def start(message: Message):
    ...
    await message.answer(
        "🔮 Арканум\n\n"
        "Добро пожаловать!\n\n"
        "Персональные AI-разборы на основе карт Таро.\n\n"
        "Доступно:\n\n"
        "🎁 Карта дня\n"
        "🌟 Общий расклад\n"
        "❤️ Отношения\n"
...
async def about(message: Message):
    await message.answer(
        "ℹ️ О боте\n\n"
        "Арканум — это AI-бот для мягких развлекательных разборов на основе карт Таро.\n\n"
        "Карты помогают посмотреть на ситуацию под новым углом, лучше понять эмоции, отношения, работу и личные вопросы.\n\n"
        "Доступные разделы:\n\n"
        "🎁 Карта дня\n"
        "🌟 Общий расклад\n"
        "❤️ Отношения\n"
